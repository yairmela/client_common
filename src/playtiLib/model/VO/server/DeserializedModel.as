package playtiLib.model.VO.server
{
	...
	public class DeserializedModel	{
		public function DeserializedModel(){
			...
			if ( json != null ){
				...
				for each( var property_info:Object in vo_properties ) {
					...
					if( json.hasOwnProperty( key ) && json[key] != null ) {
						...
						} else if( new property_info.type is DeserializedModel ) {//recursivly build more serverDataVOs
							var server_vo:DeserializedModel = new property_info.type as DeserializedModel;
