package playtiLib.controller.commands.social.fb
{
	...
	/**
	 * Sets the user id by the flash vars(viewer_id property) and sends notification SOCIAL_INSTALL_APPROVED.
	...
	public class FBAssetsLoadCompleteCommand extends SimpleCommand{
		...
		override public function execute( notification:INotification ):void {
			...
			SocialCallsConfig.SOCIAL_APP_FRIENDS_IDS.request_params.user_id = flashVarsProxy.flash_vars.viewer_id;
