package playtiLib.config.server
{
	...
	public class GeneralCallsConfig	{
		...
		private static const USER_LOGIN:DataCallConfig = new DataCallConfig( ServerModulesConfig.LOGIN, 'LOGIN', false, null, LoginVO );
...
//		private static const UPDATE_USER_INFO:DataCallConfig = new DataCallConfig( ServerModulesConfig.COMMON, 'UPDATE_USER_INFO' );
		public static const GET_USER_INFO:DataCallConfig = new DataCallConfig( ServerModulesConfig.COMMON, 'GET_USER_INFO', true, null, UserSocialInfo );
//		public static const BUY_CHIPS:DataCallConfig = new DataCallConfig( ServerModulesConfig.PAYMENT, 'BUY_CHIPS' );
		public static const PREPARE_GIFT:DataCallConfig = new DataCallConfig( ServerModulesConfig.GIFT, 'PREPARE_GIFT' );
